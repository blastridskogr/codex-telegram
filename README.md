...
- mirrors only the last 2 hours of session history, anchored to the latest message in that session, when you switch sessions
...
- Session switching mirrors only the last 2 hours of session history before the latest message in that session back to Telegram as display-only chat messages. This does not spend extra model tokens.
