...
- when you switch sessions, only the user inputs and the latest Codex summary from the last 2 hours of session history before the latest message in that session are mirrored back into Telegram as display-only chat output
