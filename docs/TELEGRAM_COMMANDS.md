...
- when you switch sessions, only the last 2 hours of session history before the latest message in that session are mirrored back into Telegram as display-only chat output
