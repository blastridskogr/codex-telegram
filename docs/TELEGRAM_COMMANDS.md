...
| `/codex_session` | open a project-grouped recent-session picker |
...
- the picker groups recent sessions under project path headers
- each session button binds that Telegram chat to the selected Codex session
